...
def Run_KnnSequential(query_image_path='utils/500_datos/00000000_charmander(3).png', feature_path = 'VectorFeatures/image_features_500.npz', carpeta = 'utils/500_datos', k=5):
...
def Run_RangeSearch(query_image_path='poke2/00000001.jpg', feature_path = 'VectorFeatures/image_features_500.npz', carpeta = 'utils/500_datos', radius=0.5):
