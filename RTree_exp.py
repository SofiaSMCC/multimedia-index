...
def Run_KnnRtree(query_image_path='utils/500_datos/00000000_charmander(3).png', feature_path = 'VectorFeatures/image_features_500.npz', carpeta = 'utils/500_datos', k=5):
